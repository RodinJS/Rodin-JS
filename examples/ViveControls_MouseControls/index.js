...
var mouseController = new RODIN.MouseController(scene, null);
...
for (var i = 0; i < 12; i++) {
    ...
    obj.on(RODIN.CONSTANTS.EVENT_NAMES.HOVER, (evt, controller) => {
        console.log(obj.object3D);
    });
}
...
function mouseControllerKeyDown(keyCode, gamepad) {
    console.log(keyCode);
}

function mouseControllerKeyUp(keyCode, gamepad) {
    console.log(keyCode);
}
