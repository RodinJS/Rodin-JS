...
/*import '../../_build/js/cannon/cannon.demo.js';

 import '../../node_modules/cannon/libs/TrackballControls.js';
 import '../../node_modules/cannon/libs/Detector.js';
 import '../../node_modules/cannon/libs/dat.gui.js';
 import '../../node_modules/cannon/libs/smoothie.js';
 import '../../node_modules/cannon/libs/Stats.js';*/
...
//let worldPhysics = new RODIN.RodinPhysics(0);
scene.physics = new RODIN.RodinPhysics(0);
...
scene.add(ground);
let groundRigidBody = new RODIN.RigidBody(ground, 0);
rigidBodies.push(groundRigidBody.rigidBody);
scene.physics.addRigidBodyToWorld(groundRigidBody.rigidBody);

/// todo axis object XYZ ///
...
for (let i = 0; i < 30; i++) {
    ...
    // add physic
    let objRigidBody = new RODIN.RigidBody(obj.object3D, mass);
    rigidBodies.push(objRigidBody.rigidBody);
    scene.physics.addRigidBodyToWorld(objRigidBody.rigidBody);
...
function animate(timestamp) {
    ...
    scene.physics.updateWorldPhysics(timestamp, rigidBodies);
