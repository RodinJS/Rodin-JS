    ...
    constructor(object) {
        ...
        if (this.physicsEngine === 'oimo') {
            this.body = {
               ...
               /* pos: [this.owner.position.x * 100,
                    this.owner.position.y * 100,
                    this.owner.position.z * 100],
                rot: [ (this.owner.rotation.x * 180)/Math.PI,
                    (this.owner.rotation.y * 180)/Math.PI,
                    (this.owner.rotation.z * 180)/Math.PI],*/
                move: this.dynamic,
