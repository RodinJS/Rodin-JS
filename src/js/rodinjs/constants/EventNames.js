...
export const RIGHT_CLICK = 'rightclick';

export const STEREO_HOVER = 'stereohover';
export const STEREO_HOVER_OUT = 'stereohoverout';
export const STEREO_MOUSE_DOWN = 'stereomousedown';
export const STEREO_MOUSE_UP = 'stereomouseup';
export const STEREO_CLICK = 'stereoclick';

export const TOUCH_START = 'touchstart';
export const TOUCH_END = 'touchend';
export const TAP = 'tap';

export const CONTROLLER_HOVER = 'controllerhover';
export const CONTROLLER_HOVER_OUT = 'controllerhoverout';
