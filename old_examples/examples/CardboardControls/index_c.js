...
System.register(['../../_build/js/vendor/three/THREE.GLOBAL.js', '../../_build/js/rodinjs/RODIN.js', '../../_build/js/rodinjs/utils/ChangeParent.js', '../../_build/js/vendor/three/examples/js/controls/VRControls.js', '../../_build/js/vendor/three/examples/js/effects/VREffect.js', '../../_build/js/vendor/three/examples/js/loaders/OBJLoader.js', '../../_build/js/vendor/three/examples/js/WebVR.js'], function (_export, _context) {
    ...
    var THREE, RODIN, WTF, changeParent, renderer, scene, camera, controls, effect, params, manager, controller, geometry, material, floor, light, group, geometries, _loop, i;
    ...
    return {
        ...
        }, function (_node_modulesThreeExamplesJsControlsVRControlsJs) {}, function (_node_modulesThreeExamplesJsEffectsVREffectJs) {}, function (_node_modulesThreeExamplesJsLoadersOBJLoaderJs) {}, function (_node_modulesThreeExamplesJsWebVRJs) {}],
        execute: function () {
