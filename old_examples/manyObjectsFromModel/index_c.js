...
System.register(['../../_build/js/vendor/three/THREE.GLOBAL.js', '../../_build/js/rodinjs/RODIN.js', '../../_build/js/vendor/three/examples/js/controls/VRControls.js', '../../_build/js/vendor/three/examples/js/effects/VREffect.js'], function (_export, _context) {
    ...
    var THREE, RODIN, WTF, renderer, scene, camera, controls, effect, distanceRatio, boxSize, loader, params, manager, CardboardObject, light1, light2, amlight, cubesCount, _loop, i, lastRender, display;
    ...
    return {
        ...
        execute: function () {
            ...
            scene.add(amlight);cubesCount = 500;
