...
System.register(['../../_build/js/vendor/three/THREE.GLOBAL.js', '../../_build/js/rodinjs/RODIN.js', '../../_build/js/vendor/three/examples/js/controls/VRControls.js', '../../_build/js/vendor/three/examples/js/effects/VREffect.js', '../../_build/js/vendor/three/examples/js/loaders/FBXLoader.js'], function (_export, _context) {
    "use strict";

    var THREE, RODIN, WTF, renderer, scene, camera, skybox, controls, effect, distanceRatio, boxSize, loader, params, manager, light1, light2, amlight, obj, time, display;
    ...
    return {
        ...
        }, function (_buildJsVendorThreeExamplesJsControlsVRControlsJs) {}, function (_buildJsVendorThreeExamplesJsEffectsVREffectJs) {}, function (_buildJsVendorThreeExamplesJsLoadersFBXLoaderJs) {}],
        execute: function () {
            ...
            obj = new RODIN.FBXModelObject(0, './model/xsi_man_skinning.FBX', ['./model/Char_UV_Texture.gif']);
