...
System.register(['../../_build/js/rodinjs/RODIN.js', '../../_build/js/vendor/three/THREE.GLOBAL.js', '../../_build/js/rodinjs/Tween.js', '../../_build/js/vendor/three/examples/js/controls/VRControls.js', '../../_build/js/vendor/three/examples/js/effects/VREffect.js'], function (_export, _context) {
    "use strict";

    var WTF, THREE, TWEEN, RODIN, skybox, renderer, scene, camera, controls, effect, distanceRatio, boxSize, loader, params, manager, boxCount, particleBoxSize, geometry, material, cubes, i, lastRender, display;
    ...
    function animate(timestamp) {
        ...
        for (var _i = 0; _i < boxCount; _i++) {
            cubes[_i].rotation.y += delta * 0.001;
        }
    ...
    return {
        ...
        }, function (_buildJsVendorThreeTHREEGLOBALJs) {
