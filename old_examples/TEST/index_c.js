...
System.register(['../../_build/js/rodinjs/RODIN.js', '../../_build/js/vendor/three/THREE.GLOBAL.js', '../../_build/js/rodinjs/Tween.js', '../../_build/js/vendor/three/examples/js/controls/VRControls.js', '../../_build/js/vendor/three/examples/js/effects/VREffect.js'], function (_export, _context) {
    ...
    var WTF, THREE, TWEEN, RODIN, tween, renderer, scene, camera, controls, effect, distanceRatio, boxSize, loader, params, manager, boxCount, particleBoxSize, geometry, material, cubes, i, lastRender, display;
